            ...
            if window != main_handle:
                ...
                if follow_up_form is None:
                    ...
                    if follow_up_form is not None:
                        ...
                        if debug:
                            time.sleep(3)
                            save_screenshot(debug_form_post_followup, webdriver, browser_params, manager_params)
...
def _form_fill_and_submit(form, user_info, webdriver, clear, browser_params, manager_params, screenshot_filename):
    ...
    if screenshot_filename:
        save_screenshot(screenshot_filename, webdriver, browser_params, manager_params)
